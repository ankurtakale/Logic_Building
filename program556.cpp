                ...
                )
{
    ...
    // Note : 0,1,2 are reserved(stdin,stdout,stderror)
    ...
    return i;       // Returns File Descriptor(fd)
...
int main()
{
    ...
    while(1)
    {
        ...
        else if(iCount == 2)
        {
            ...
            // Marvellous CVFS : > write 2              (Here 2 is the fd of file)
        ...
        else if(iCount == 3)
        {
            ...
            // Marvellous CVFS : > read 3 10            (Where 3 is fd and 10 is no. of bytes want to read)
